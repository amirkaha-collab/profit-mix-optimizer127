...
def _call_claude(prompt: str, system: str = "", max_tokens: int = 3200,
                 model: str = "claude-sonnet-4-6") -> tuple[str, Optional[str]]:
    api_key = _get_api_key()
    if not api_key:
        return "", "לא הוגדר מפתח API. הזן את מפתח ANTHROPIC_API_KEY בתיבה למטה."
    ...
    try:
        ...
        if resp.status_code == 200:
            ...
            return "", "מפתח API לא תקין — בדוק שהמפתח נכון."
