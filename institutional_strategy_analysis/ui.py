...
def render_institutional_analysis():
    """Render the full "ניתוח אסטרטגיות מוסדיים" page."""

    # ── Page header ───────────────────────────────────────────────────────
    st.markdown("""
<div style='background:linear-gradient(135deg,#134e3a 0%,#15803d 60%,#16a34a 100%);
     border-radius:14px;padding:18px 24px;margin-bottom:18px;direction:rtl'>
  <div style='color:#fff;font-size:20px;font-weight:900'>📐 ניתוח אסטרטגיות מוסדיים</div>
  <div style='color:#bbf7d0;font-size:12px;margin-top:4px'>
    אלוקציה · גידור מט"ח · דינמיות · השוואה בין גופים · ניתוח AI מעמיק
  </div>
</div>""", unsafe_allow_html=True)
    ...
    filters    = {"managers": sel_mgr, "tracks": sel_tracks, "allocation_names": sel_allocs}
